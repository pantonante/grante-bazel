...
#include "grante/MaximumCompositeLikelihood.h"
...
int main()
{
  ...
  Grante::MaximumCompositeLikelihood mcl(graph.model.get(), 0);
  mcl.SetupTrainingData(training_data, inference_methods);
  mcl.Train(1.0e-8, 100);
